...
export const dynamicContent = {
  ...
  default_default_default: {
    ...
    paragraph1: "Автоматизируйте процессы, увеличивайте прибыль и масштабируйте свой бизнес, освобождая время для стратегического развития. Мы предлагаем современные IT-решения, созданные специально для вас.",
