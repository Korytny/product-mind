  ...
  return (
    <div className="glass-card overflow-hidden animate-on-scroll">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="overflow-hidden w-full order-1 md:order-2 relative md:h-full">
          <AnimatedImage
            src={image}
            alt={title}
            className="w-full h-full object-cover md:object-cover md:object-bottom transition-transform duration-700 hover:scale-105"
