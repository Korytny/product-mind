      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              Автоматизация бизнес-процессов с использованием искусственного интеллекта для увеличения эффективности и прибыли
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a 
                  href="mailto:info@aibusiness.com" 
                  className="text-gray-300 hover:text-white transition-colors"
                >
                  info@aibusiness.com
                </a>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6">Присоединяйтесь</h4>
            <div className="flex space-x-4 mb-6">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center transition-colors hover:bg-accent"
                aria-label="Facebook"
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 pt-8 border-t border-white/10">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} AI Business. Все права защищены.
          </p>
          <a 
            href="#hero" 
